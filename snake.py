...
title.hideturtle()
title.goto(0,320)
title.write("SNAKE", align = "center", font = ("Times new roman", 24, "normal"))
...
game_over.goto(0,320)
#game_over.write("SNAKE", align = "center", font = ("Times new roman", 24, "normal"))
...
def check_collision():
    if snake.xcor() > 290 or snake.xcor() < -280 or snake.ycor() > 280 or snake.ycor() < -338:
        return True
...
while True:
    ...
    if check_collision():
        title.clear()
        game_over.write(" Game Over. Thank you for Playing", align = "center", font = ("Times new roman", 24, "normal"))
        snake.goto(-58,0)
        snake.direction = 'Stop'
        for segment in body:
